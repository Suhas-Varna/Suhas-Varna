...
- Trainer and workout class scheduling
- Complete CRUD operations

**Tech Stack:** `MySQL` `Streamlit` `Python`
...
**Tech Stack:** `Java` `JDBC` `SQLite` `Swing`
...
✅ Participated in department-level coding hackathons  
✅ Active NSS volunteer (Campus Swachata Drive, Plantation Events)
